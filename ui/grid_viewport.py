...
class GridViewport(QGraphicsView):
    ...
    def update_view(self, grid, show_grid, sensors, is_accumulated=False, show_values=False, csv_grid=None, used_csv_indices=None, max_source_pos=None, true_source_pos=None, predicted_pos=None):
        self.renderer.draw(
